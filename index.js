...
async function msgHandler (client, message) {
    try {
        ...
        const commands = ['#menu','#help','#sticker', '#stiker', '#tiktok', '#promo']
        ...
        if (cmd) {
            ...
            switch (cmd[0]) {
                case '#promo':
                    client.sendText(from, '*Netflix Private And Shared !*\n*Netflix Premium Ultra HD🔥*\n*Private* :\n•Resolusi 4K+\n•Bergaransi \n•Bisa di pakai di TV/Laptop/HP\n•Bisa login 5 device\nHarga asli *169* ?❌ dikita Mulai dari *65rb* Aja sob✅\n\n*Shared* :\n•Resolusi 4K+\n•Bergaransi \n•Bisa di pakai di TV/Laptop/HP\n•1 Profile 1 Device \nHarga mulai *20rban* ✅\n*Payment : DANA , JENIUS , GOPAY , OVO*\n\n*CP:* wa.me/089606026244')
                    break
                case '#menu':
                case '#help':
                    client.sendText(from, 'Menu: \n1. #promo: Promo yang tersedia di sini \n2. #sticker / #stiker: kirim gambar dengan caption atau balas gambar yang sudah dikirim. \n3. #sticker / #stiker spasi url gambar (contoh: #stiker http://cdn.dota2.com/apps/dota2/images/blogfiles/cct_lsraks_blog_header.png) \n4. #tiktok spasi url (contoh: #tiktok https://www.tiktok.com/@adedaffa/video/685521...)\n\nDonasi melalui: \nGopay:+6285156923294 \nOVO/DANA:+6289606026244 \n\nInstagram.com/empty.simple \nMade with ❤️ ')
                    break
                case '#sticker':
                case '#stiker':
                    if (isMedia) {
                    ...
                    if (args.length == 2) {
                        ...
                        if (url.match(isUrl) && url.includes('tiktok.com')) {
                            ...
                            await client.sendFile(from, videoMeta.videobase64, filename, videoMeta.NoWaterMark ? '' : 'Maaf, video tanpa watermark tidak tersedia')
                                .then(await client.sendText(from, `Metadata:\nUsername: ${videoMeta.authorMeta.name} \nMusic: ${videoMeta.musicMeta.musicName} \nView: ${videoMeta.playCount.toLocaleString()} \nLike: ${videoMeta.diggCount.toLocaleString()} \nComment: ${videoMeta.commentCount.toLocaleString()} \nShare: ${videoMeta.shareCount.toLocaleString()} \nCaption: ${videoMeta.text.trim() ? videoMeta.text : '-'} \n\nDonasi: bantu aku beli server dengan menyawer melalui https://saweria.co/adedaffa \nInstagram: https://instagram.com/empty.simple \nTerimakasih.`))
                                .catch(err => console.log('Caught exception: ', err))
                        } else {
                            client.sendText(from, 'Maaf, Url yang kamu kirim tidak valid')
                        }
